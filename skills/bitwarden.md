---
name: client1-bitwarden
description: Manage Bitwarden secrets and vault items for CLIENT1 infrastructure.
mode: skill
...
- All infrastructure secrets should ideally be stored in the "CLIENT1 IT" organization.
